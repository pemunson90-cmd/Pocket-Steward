...
android {
    ...
    buildTypes {
        release {
            ...
            // Real-device acceptance builds stay unminified so hardware tests
            // exercise the same code paths as the green debug/instrumentation
            // suite, and package only the canonical phone ABI.
